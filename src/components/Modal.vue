<script setup>
    ...
    const emit = defineEmits(['ocultarModal', 'guardarGasto', 'eliminarGasto','update:nombre', 'update:cantidad', 'update:categoria'])
    ...
    const agregarGasto = () => {
        ...
        // Valdar que el usuario no gaste mas de lo disponible
        if(id){
